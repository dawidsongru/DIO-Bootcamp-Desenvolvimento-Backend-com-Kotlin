// Desafio de Código: Extension Function
// Gerando Slugs de Livros
// https://web.dio.me/coding/desafio-de-codigo-gerando-slugs-de-livros/algorithm/gerando-slugs-de-livros?back=/track/desenvolvimento-backend-com-kotlin&tab=undefined&moduleId=undefined
...
fun String.generateSlug(): String {
    val slug = this
        .toLowerCase()
        .replace(" ", "-") // Substitui espaços por traços
        .replace(Regex("[^a-zA-Z0-9-]"), "") // Remove caracteres especiais
    return slug
}
