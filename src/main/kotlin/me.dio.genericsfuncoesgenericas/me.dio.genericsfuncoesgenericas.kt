...
package me.dio.genericsfuncoesgenericas
...
fun <E> mutableStackOf(vararg elements: E) = MutableStack(*elements)        // Função Utilitária chamada mutableStackOf
                                                                            // Função que recebe um (vararg elements: E)
                                                                            // <E> tipo genérico sendo passado pra ela
                                                                            // Quando essa função for chamada, eu quero criar uma nova MutableStack...
                                                                            // ... passando o vararg pra ela.
                                                                            // Propagando o (vararg elements: E) para o construtor da MutableStack(*elements)
                                                                            // * indica que está passando o parâmetro do tipo vararg como elemento...
                                                                            // ... em tempo de construção pra minha pilha.
